        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-sm bg-zinc-900 border border-zinc-800 flex items-center justify-center text-white shrink-0 shadow-md">
            ...
            <div className="p-4 bg-[rgba(15,15,18,0.92)] border border-zinc-800/90 rounded-sm backdrop-blur-2xl space-y-2 shadow-xl">
          ...
          >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute -top-5 -right-4 z-20 items-center gap-2 px-3.5 py-1.5 rounded-sm bg-zinc-900/95 border border-zinc-700/80 backdrop-blur-xl text-xs font-mono text-white shadow-2xl"
            >
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute -bottom-5 -left-4 z-20 items-center gap-2 px-3.5 py-1.5 rounded-sm bg-zinc-900/95 border border-zinc-700/80 backdrop-blur-xl text-xs font-mono text-zinc-300 shadow-2xl"
            >
            ...
            <div className="bg-[rgba(15,15,18,0.92)] border border-zinc-800/90 rounded-sm p-5 sm:p-7 backdrop-blur-2xl shadow-2xl space-y-5 overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-zinc-800/80 pb-3">
                ...
                <span className="text-[10px] font-mono text-zinc-300 bg-zinc-900 border border-zinc-800 px-2.5 py-0.5 rounded-sm flex items-center gap-1">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-zinc-900/80 border border-zinc-800 rounded-sm space-y-3 shadow-md">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-mono font-bold text-white bg-zinc-800 border border-zinc-700 px-2.5 py-1 rounded-sm">
                      78% Completed
                    </span>
                  </div>

                  <div className="w-full bg-zinc-800 h-2 rounded-sm overflow-hidden">
                    <div className="w-[78%] h-full bg-white rounded-sm" />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {/* Milestones Widget */}
                  <div className="p-4 bg-zinc-900/80 border border-zinc-800 rounded-sm space-y-2.5 shadow-md">
                ...
                <div className="p-3.5 bg-zinc-900/80 border border-zinc-800 rounded-sm flex items-center justify-between text-xs font-mono shadow-md">
