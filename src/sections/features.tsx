      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-10 lg:px-12 w-full space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-zinc-400 leading-relaxed">
            Bunker combines project tracking, live GitHub sync, living documentation, and client collaboration into one premium operating system.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            className="group relative p-8 sm:p-10 bg-[rgba(15,15,18,0.85)] border border-zinc-800/80 rounded-sm backdrop-blur-2xl shadow-2xl hover:border-zinc-700 transition-all duration-200 overflow-hidden"
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 space-y-5">
                <div className="w-12 h-12 rounded-sm bg-zinc-900 border border-zinc-800 flex items-center justify-center text-white group-hover:-translate-y-0.5 transition-transform duration-200 shadow-lg">
              ...
              <div className="lg:col-span-6">
                <div className="p-5 bg-zinc-900/90 border border-zinc-800 rounded-sm space-y-3 shadow-xl backdrop-blur-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="group p-6 sm:p-7 bg-[rgba(15,15,18,0.85)] border border-zinc-800/80 rounded-sm backdrop-blur-2xl shadow-xl hover:border-zinc-700 hover:scale-[1.01] transition-all duration-200 space-y-4"
            >
              <div className="w-12 h-12 rounded-sm bg-zinc-900 border border-zinc-800 flex items-center justify-center text-white group-hover:-translate-y-1 transition-transform duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.2, delay: 0.05 }}
              className="group p-7 sm:p-8 bg-[rgba(15,15,18,0.85)] border border-zinc-800/80 rounded-sm backdrop-blur-2xl shadow-xl hover:border-zinc-700 hover:scale-[1.01] transition-all duration-200 space-y-4"
            >
              <div className="w-12 h-12 rounded-sm bg-zinc-900 border border-zinc-800 flex items-center justify-center text-white group-hover:-translate-y-1 transition-transform duration-200">
